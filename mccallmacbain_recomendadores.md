...
- **Precisam de 2 cartas de recomendação** específicas (formulário enviado diretamente pelo portal)

---

## Recomendadores Ideais para Thiago

### 1. CEO ou VP da Laudite
→ Falar sobre: liderança interna, crescimento, impacto no produto e nos clientes

### 2. Co-fundador da Dream Bots OU coordenador do START Global Fellowship
→ Falar sobre: espírito empreendedor, resiliência, capacidade de construir do zero
...
**O que a McCall MacBain quer ver:**
...
- A criação de sistemas de onboarding/enablement que ele desenvolveu do zero
- Qualquer NPS ou métrica de adoção que melhorou sob a liderança dele
- Como ele pensa em produto com visão de negócio, não só de execução

---

### Para o recomendador da Dream Bots / START Global:
...
**Pontos específicos sugeridos:**
- A transformação de ideia em MVP durante o START Global Fellowship (St. Gallen, Suíça)
- Os desafios de co-fundar uma empresa sendo estudante simultaneamente
- Qualquer cliente, receita ou impacto real que a Dream Bots gerou
- Como o Thiago se destacou no contexto internacional do Fellowship
...
- [ ] **Junho:** Quando portal abrir, preencher candidatura e acionar o sistema para enviar formulário aos recomendadores
- [ ] **Julho:** Verificar se os recomendadores receberam o formulário; oferecer briefing adicional se necessário
- [ ] **Até 19/08:** Submeter candidatura completa
...
*Arquivo gerado por Andy para facilitar a preparação da candidatura McCall MacBain 2026.*
