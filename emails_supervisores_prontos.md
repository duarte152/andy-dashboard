...
**Assunto:** Prospective MRes Student — Longitudinal CDSS Adoption & Enablement Interventions | USyd 2027
...
Your 2025 systematic review in NPJ Digital Medicine on clinicians' acceptance and use of clinical decision support systems over time captures a pattern I have seen repeatedly in practice. The most important word in your title is *over time*. What I observe at Laudite is that adoption does not follow a smooth curve: there is typically early enthusiasm, then a plateau or even regression as the novelty fades and cognitive load accumulates, followed — in the cases where we intervene well — by genuine, sustained integration. In the cases where we do not, the tool becomes shelfware despite clinical efficacy. The system works. The adoption does not.
