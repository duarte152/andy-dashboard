# Emails Personalizados - Top 5 Supervisores (Reino Unido)

*Redigidos em: 2026-04-23*
*Instrução: copiar, revisar, e enviar de thiago.duarte152@gmail.com*
*Anexar: cv_english.md (converter para PDF antes)*
*Bolsa de referência: Chevening Scholarship*
...
My name is Thiago Rocha Duarte, currently working as Product Specialists & Product Enablement Lead at Laudite - Brazil's leading generative AI platform for medical reporting, used by over 3,500 clinicians across radiology, pathology, and endoscopy. Laudite uses an LLM pipeline to generate structured clinical reports from voice dictation and prior data, with clinicians retaining full decision-making authority. Over four years, I have worked directly with those clinicians as they navigate new AI-assisted workflows, sitting at the junction between clinical need, product capability, and the organisational realities of healthcare delivery.

Your work on Learning Health Systems - particularly the vision of capturing point-of-care data to feed analytical cycles that produce actionable clinical knowledge, deployable via CDSS integrated in EHRs - resonates directly with the gap I observe in practice. At Laudite, I see both sides of this cycle: the moment a clinician interacts with a system, and the long, often unclear path between that interaction and any meaningful improvement in how care is delivered. The ROAD2H project's aim of translating clinical guidelines into computable knowledge that reaches clinicians at the point of decision is exactly the kind of challenge I have observed from the deployment side.

I have been thinking about how the design of the interface between clinical AI systems and healthcare workflows shapes whether those systems generate and sustain the feedback loops that Learning Health Systems depend on - and I would be grateful to be guided by your expertise on where the most relevant directions lie within your current work.
...
My name is Thiago Rocha Duarte, currently working as Product Specialists & Product Enablement Lead at Laudite - Brazil's leading generative AI platform for medical reporting, used by over 3,500 clinicians across radiology, pathology, and endoscopy. Laudite uses an LLM pipeline to generate structured clinical reports, with clinicians retaining full decision-making authority. My work sits squarely in the territory your research addresses: the messy, socially contingent process by which digital tools either embed into clinical practice or fail to.

Your work developing the NHS ePrescribing Toolkit, and your broader research on the sociotechnical dynamics of health IT adoption, gives rigorous form to patterns I encounter empirically every day. Every deployment I have been part of at Laudite involves a negotiation - between the logic of the software and the logic of clinical work, between the expectations of product teams and the realities of clinical teams. Understanding why some of those negotiations succeed and others quietly collapse is precisely what drives my interest in graduate research.

I have been thinking about how sociotechnical factors shape the sustained adoption of digital health tools in clinical settings - and I would be grateful to be guided by your expertise on where the most relevant directions lie within your current research.
...
Your research on AI-enabled digital health systems - particularly the challenge of deploying AI algorithms safely and responsibly in high-stakes clinical environments, and the work you have done with clinical teams to integrate AI into hospital workflows with appropriate risk controls - connects directly to what I observe in practice. At Laudite, the question of how to move from a technically functional AI system to one that clinicians actually trust and integrate into their daily workflow is one I work on daily. The gap between deployment and genuine clinical adoption is precisely where I have spent most of my professional energy.

I have been thinking about how the design of behavioural interventions around clinical AI tools affects adoption and responsible use in practice - and I would be grateful to be guided by your expertise on where the most relevant directions lie within your current work.
...
3. **Ordem recomendada:** Lilaonitkul → Delaney → Neves → Cresswell → Taylor
4. **Follow-up:** se não houver resposta em 14 dias, enviar email breve de follow-up
5. **Chevening deadline:** verificar em chevening.org - candidaturas geralmente abrem em agosto/setembro
6. **Nota sobre visto:** cidadania portuguesa não elimina necessidade de Student Visa para UK pós-Brexit, mas experiência profissional sólida ajuda na elegibilidade Chevening
